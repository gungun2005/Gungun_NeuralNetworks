...
The model learns to draw a line (Decision Boundary) that separates two classes of data. As the Gradient Descent progresses, the training loss decreases and accuracy increases.
***Environment & Setup***
